...
System.config({
  "map": {
    ...
    "npm:fsevents@1.0.6": {
      ...
      "fs": "github:jspm/nodelibs-fs@0.1.2",
      "nan": "npm:nan@2.1.0",
      "node-pre-gyp": "npm:node-pre-gyp@0.6.18",
      "path": "github:jspm/nodelibs-path@0.1.0",
      "process": "github:jspm/nodelibs-process@0.1.2",
      "util": "github:jspm/nodelibs-util@0.1.0"
    },
    ...
    "npm:riot-cli@2.3.14": {
      ...
      "path": "github:jspm/nodelibs-path@0.1.0",
      "process": "github:jspm/nodelibs-process@0.1.2",
      "riot-compiler": "npm:riot-compiler@2.3.19",
      "rollup": "npm:rollup@0.21.3",
      "shelljs": "npm:shelljs@0.5.3",
      "systemjs-json": "github:systemjs/plugin-json@0.1.0"
    },
    "npm:riot-compiler@2.3.19": {
      "buffer": "github:jspm/nodelibs-buffer@0.1.0",
      "fs": "github:jspm/nodelibs-fs@0.1.2",
      "path": "github:jspm/nodelibs-path@0.1.0",
      "process": "github:jspm/nodelibs-process@0.1.2"
    },
    "npm:riot-route@2.3.13": {
    ...
    "npm:riot@2.3.12": {
      ...
      "riot-compiler": "npm:riot-compiler@2.3.19",
      "riot-observable": "npm:riot-observable@2.3.14",
      "riot-route": "npm:riot-route@2.3.13",
      "riot-tmpl": "npm:riot-tmpl@2.3.19",
